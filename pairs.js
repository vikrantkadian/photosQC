...
window.PAIRS = [
  // ---- Set 1 — difference should be clearly perceptible (original pair numbers: 1, 24, 30, 29, 10, 16, 19, 3) ----
  ...
  // ---- Set 2 (original pair numbers: 4, 18, 11, 12, 28, 21, 23, 17) ----
  ...
  // ---- Set 3 (old pair 8 = JPEG-blocking showcase) (original pair numbers: 14, 20, 26, 8, 5, 13, 7) ----
  ...
  // ---- Set 4 — subtlest differences (original pair numbers: 22, 9, 25, 2, 15, 6, 27) ----
